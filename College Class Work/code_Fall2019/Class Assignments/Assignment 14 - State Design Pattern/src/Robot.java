...
public class Robot implements RoboticState{
	...
	private RoboticState roboticWalk;
	...
	public Robot(){
		...
		this.roboticWalk = new RoboticWalk(this);
	...
	public RoboticState getRoboticWalk() {
		return roboticWalk;
	}

	public void setRoboticWalk(RoboticState roboticWalk) {
		this.roboticWalk = roboticWalk;
	}
