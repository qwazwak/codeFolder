...
public class BlackJackHand
{
   ...
   public BlackJackHand(Card card1, Card card2)
   {
	  ...
	  this.soft = (card1.getFaceInt() == 1 ||  card2.getFaceInt() == 1) ? true : false;
   ...
   public int handValue()
   {
      ...
      if (total[1] <= 21)
      {
		 ...
		 value = total[1];
		 //NOTE: may want to change to total[0]
      }
   ...
   public BlackJackHand[] split(Card card1, Card card2)
   {
      ...
      if (canSplit())
      {
         ...
         split[0] = new BlackJackHand(this.hand.get(0), card1);
         split[1] = new BlackJackHand(this.hand.get(1), card2); 
      }
