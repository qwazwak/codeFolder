...
To use Rus's Big Bad Library:
	Include it with #include "BigBadLib_CSC.h"
	and when LINKING make sure that this header and the BigBadLib_CSC.o are in the same directory as your file, and link them IE: g++ -o myprogram.exe mypProgram.o BigBadLib_CSC.o
