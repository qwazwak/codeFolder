...
To use Rus's Big Bad Library:
	Include it with #include "BigBadLib-Rus.h"
	and when LINKING make sure that this header and the BigBadLib-Rus.o are in the same directory as your file, and link them IE: g++ -o myprogram.exe mypProgram.o BigBadLib-Rus.o
